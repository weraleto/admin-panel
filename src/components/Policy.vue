    ...
    <transition name="fade" mode="out-in">
        <main class="main-content" >
            <div class="quiz-welcome-outer">
                 <!-- main header -->
                <header>
                    <h1 class="page-header">Условия пользовательского соглашения</h1>
                </header>
                <!-- auth form -->
                <div class="form-content quiz-welcome policy">
                   <h3>Общие положения</h3>
Настоящее Пользовательское Соглашение (Далее Соглашение) регулирует отношения между владельцем www.mydizi.design (далее Dizi или Администрация) с одной стороны и пользователем сайта с другой. Сайт Dizi не является средством массовой информации.
<br>
Используя сайт, Вы соглашаетесь с условиями данного соглашения. Если Вы не согласны с условиями данного соглашения, не используйте сайт Dizi! <br><br>

<h3>Предмет соглашния</h3>
Администрация предоставляет пользователю право на размещение на сайте следующей информации:<br>

- Текстовой информации<br>
- Фотоматериалов<br>
- Ссылок на материалы, размещенные на других сайтах<br><br>
